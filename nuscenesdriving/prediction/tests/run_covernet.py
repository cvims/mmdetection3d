...
from nuscenesdriving.prediction.models.backbone import MobileNetBackbone
from nuscenesdriving.prediction.models.covernet import CoverNet, ConstantLatticeLoss
