_base_ = [
    '../_base_/datasets/nus-driving-3d.py',
    '../_base_/models/centerpoint_voxel01_second_secfpn_nus-driving.py',
...
# runtime settings
train_cfg = dict(by_epoch=True, max_epochs=num_epochs, val_interval=25)
