...
def parse_args():
    ...
    #                     default='work_dirs/pointpillars_hv_fpn_sbn-all_8xb4-2x_nus-driving-3d/pointpillars_hv_fpn_sbn-all_8xb4-2x_nus-driving-3d.py',
    #                     help='test config file path')
    # parser.add_argument('--checkpoint',
    #                     default='work_dirs/pointpillars_hv_fpn_sbn-all_8xb4-2x_nus-driving-3d/epoch_250.pth',
