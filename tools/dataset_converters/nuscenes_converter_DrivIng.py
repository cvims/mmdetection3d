...
def create_nuscenes_driving_infos(root_path,
    ...
    print('TODO REMOVE NEXT LINE - THIS IS JUST FOR TESTING!')
...
def get_available_scenes(nusc):
    ...
    for scene in nusc.scene:
        ...
        sd_rec = nusc.get('sample_data', sample_rec['data']['middle_lidar'])
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmengine.track_iter_progress(nusc.sample):
        lidar_token = sample['data']['middle_lidar']
        sd_rec = nusc.get('sample_data', sample['data']['middle_lidar'])
    ...
    for info in mmengine.track_iter_progress(nusc_infos):
        for cam in camera_types:
            ...
            coco_2d_dict['images'].append(
                dict(
                    file_name=cam_info['data_path'].split('data/nuscenes-driving/')
                    [-1],
